            ...
            <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary" onclick="resetSelect()"  id="resetearSelect">Resetear</button>
                            </div>
            ...
            <table id="dtBasicExample" class="table table-striped table-bordered" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <th class="th-sm grupoFiltro" style="font-size: 0.85em ">Grupo</th>
                        ...
                        <th class="th-sm estadoFiltro" style="font-size: 0.85em ">Estado</th>
                    </tr>
                </thead>
                <tbody>
